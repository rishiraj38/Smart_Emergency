...
This module creates an HTTP server that exposes the SmartEmergencyEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m smart_emergency.server.app
    ...
    multiple workers:
        uvicorn smart_emergency.server.app:app --workers 4
    """
    import uvicorn
